...
pub enum AuthMethod {
    ...
    Cookie { auth_cookie: String, two_fa_cookie: Option<String> },
}
...
impl Config {
    ...
    pub fn new_cookie(auth_cookie: String, two_fa_cookie: Option<String>) -> Self {
        Self { 
            auth_method: AuthMethod::Cookie { auth_cookie, two_fa_cookie } 
        }
    }
    ...
    pub fn load() -> Result<Self> {
        ...
        if !config_path.exists() {
            return Err(anyhow!("Config file not found. Please run 'vrcli auth login' first."));
        }
